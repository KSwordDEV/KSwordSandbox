...
internal sealed class InstallerContractScenario : ISmokeTestScenario
{
    ...
    public Task<SmokeTestResult> RunAsync(SmokeTestContext context, CancellationToken cancellationToken = default)
    {
        ...
        RequireContains(installer, "Recreate runtime folders", "Installer change menu should include runtime folder refresh.");
        RequireContains(installer, "Show status", "Installer change menu should include status.");
        ...
        RequireContains(doc, "recreate runtime folders", "Install doc should describe multiple change options.");
