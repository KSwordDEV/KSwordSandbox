...
### R0 defensive coverage/readiness fields

R0Collector emits additive coverage fields on driver rows and control-plane
diagnostic rows so reports can state what is directly observed and what remains
a known gap:

- `r0CoverageTaxonomyVersion=1`
- `r0CoverageCategoriesAudited=driver.load|process.lifecycle|image.load|file.activity|registry.activity|network.metadata|queue.loss.backpressure`
- `r0CoverageFieldSet`
- `r0CoverageCategory`
- `r0CoverageState`
- `r0CoverageEvidenceSource`
- `r0CoverageProducerMaskScope`
- `r0CoverageProducerMask`, `r0CoverageProducerMaskHex`, and
...
- All control-plane rows that contribute readiness/coverage evidence may also
  include `r0CoverageTaxonomyVersion`, `r0CoverageCategoriesAudited`,
