...
std::string BuildAbiSelfCheckData(const Options& options) {
    ...
    data.AddUtf8("typedPayloadSemanticFields", "semanticFamily|behaviorLane|activityKind|evidenceReady|zhMessage|zhHint|artifactCandidateKind|dropLocationFamily|persistenceFamily|imageLoadFamily|networkEvidenceKind plus process/file/registry/network family-specific hints");
    ...
    data.AddUtf8("stableJsonlFields", "sequence|sequenceMeaning|sequenceScope|sequenceConcrete|lost|lostCount|loss|lossObserved|backpressure|backpressureObserved|backpressureReason|backpressureSeverity|highWatermark|lastEnqueueFailureStatus|noise|noiseClass|selfNoiseClass|collectorNoiseClass|collectorNoise|collectorSelfNoise|selfProcess|selfNoise|selfNoiseReason|selfNoiseAction|collectorSuppressed|sampleBehaviorCandidate|producer|producerCategory|eventOrigin|subjectKind|actorRole|subjectRole|processIdSource|semanticFamily|behaviorLane|activityKind|artifactCandidateKind|dropLocationFamily|droppedFileCandidate|startupFolderCandidate|persistenceFamily|servicePersistenceCandidate|ifeoPersistenceCandidate|imageLoadFamily|injectionCandidate|networkEvidenceKind|externalAddressCandidate|lateralMovementCandidate|downloadExecuteCandidate|serviceHint|flowKey|sourceEndpoint|destinationEndpoint|zhMessage|zhHint|operationName|status|pathTruncated|schema|eventSchemaName|eventSchemaVersion|eligible|processed|emitted|suppressed|skipped|head|tail|sampling|sequenceGapReason|observedSequenceSpan|producerDroppedMask|producerSuppressedMask|producerBackpressureMask|effectiveProducerMask|lastFailureNtStatus|networkStatusAvailable|networkStatusCapability|supportedLayerMask|activeLayerMask|todoMask|classifyCount|eventCount|queueFailureCount|classifyPayloadFailureCount|lastDegradeReasonName");
